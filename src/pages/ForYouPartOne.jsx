                 ...
                 <div className='w-[500px] mx-auto px-4'>
                  ...
                  <PriceDiscount  discount={`${descount} of`} persent={pesent} className="mb-5"/>
                   <Flex className=" justify-center gap-x-5 md:justify-between">
                    ...
                    <Link to="/">
                       <button className=' w-[220px] px-4 md:px-0 py-4 bg-[#26ABD4] rounded-[2px] font-roboto font-semibold text-white text-xl md:text-2xl'>Buy now </button>
                    </Link>


                   <Link to="/add-to-card">
                      <button onClick={handleAddToCart} className=' w-[220px] px-4 md:px-0 py-4 bg-primary rounded-[2px] font-roboto text-white font-semibold text-xl md:text-2xl'>Add to Card</button>
                   </Link>
