     ...
     <Container>
            <div className="flex justify-between flex-wrap gap-y-8">
              ...
              <div className='w-[500px] mx-auto px-4'>
               <SubHeading text={peragraph} className="w-[380px] px-4 md:w-[500px] md:text-center text-black mb-4"/>
              ...
              {/* Love  */}
               ...
               <PriceDiscount  discount={`${discount} of`} persent={persent} className="mb-5"/>
                <Flex className=" justify-center gap-x-5 md:justify-between">
                <button className=' md:w-[48%] px-4 md:px-0 py-4 bg-[#26ABD4] rounded-[2px] font-roboto font-semibold text-white text-xl md:text-2xl'>Buy now </button>
                <button className=' md:w-[48%] px-4 md:px-0 py-4 bg-primary rounded-[2px] font-roboto text-white font-semibold text-xl md:text-2xl'>Add to Card</button>
                </Flex>
              </div>
...
// function FlashPartOne() {
//  let dataslocation = useLocation()
//  console.log(dataslocation.state);
...
//     //              <div className='w-[500px] mx-auto px-4'>
//     //               {/* <SubHeading text={dataLocation.state.porstionHeadingText} className="w-[380px] px-4 md:w-[500px] md:text-center text-black mb-4"/> */}
//     //                <Flex className="gap-x-10 md:justify-between items-center">
//     //                 {/* Start  */}
//     //                 <Flex className="items-center gap-x-4 items-center">
//     //                   <Flex className="text-primary gap-x-1">
//     //                     <AiFillStar/>
//     //                     <AiFillStar/>
//     //                     <AiFillStar/>
...
//     //               <div className='bg-primary py-4 px-2 md:px-8 my-5 w-[300px] md:w-[450px]'>
//     //                 <Flex className="justify-between">
//     //                   <div className=' md:w-[200px]'>
//     //                     <SubHeading text="ENJOY EXCLUSIVE OFFER DISCOUNT" className="text-4xl font-extrabold text-white"/>
//     //                   </div>
...
//     //                 </Flex>
//     //               </div>
//     //               {/* <h1 className='font-roboto font-bold text-2xl text-primary'>{dataLocation.state.price}</h1> */}
//     //               {/* <PriceDiscount  discount={`${dataLocation.state.descount} of`} persent={dataLocation.state.pesent} className="mb-5"/> */}
//     //                <Flex className=" justify-center gap-x-5 md:justify-between">
//     //                <button className=' md:w-[48%] px-4 md:px-0 py-4 bg-[#26ABD4] rounded-[2px] font-roboto font-semibold text-white text-xl md:text-2xl'>Buy now </button>
//     //                <button className=' md:w-[48%] px-4 md:px-0 py-4 bg-primary rounded-[2px] font-roboto text-white font-semibold text-xl md:text-2xl'>Add to Card</button>
//     //                </Flex>
