     ...
     <Container>
            <div className="flex justify-between flex-wrap gap-y-8">
              ...
              {/* Love  */}
               ...
               <h1 className='font-roboto font-bold text-2xl text-primary'>{`$ ${price}tk`}</h1>
               <PriceDiscount  discount={`${discount} of`} persent={persent} className="mb-5"/>
                <Flex className=" justify-center gap-x-5 md:justify-between">
                   ...
                   <Link to="/">
                       <button className='w-[150px] md:w-[220px] px-4 md:px-0 py-4 bg-[#26ABD4] rounded-[2px] font-roboto font-semibold text-white text-xl md:text-2xl'>Buy now </button>
                    </Link>
